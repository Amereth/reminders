...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'text-popover-foreground bg-background flex h-full w-full flex-col overflow-hidden rounded-md',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className='flex items-center border-b px-3' cmdk-input-wrapper=''>
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'placeholder:text-foreground bg-background flex h-10 w-full rounded-md py-3 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50',
        className,
      )}
      {...props}
    />
